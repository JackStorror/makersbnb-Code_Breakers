...
#      p @space_id[0]['space_id']
      booking = Booking_handler.add_booking(space_id: 1, booking_start: "01-03-2022", booking_end: "04-03-2022")
      persisted_data = persisted_booking_id(booking_id: booking.booking_id, table: 'bookings')

      expect(booking).to be_a Booking_handler
  ...
  describe '.all_bookings' do
    it 'returns all current bookings' do
      ...
      expect(bookings.first).to be_a Booking_handler
